...
app.use(cors({ origin: process.env.CLIENT_URL || 'http://localhost:3000', methods: ['GET', 'POST', 'DELETE'] }));
...
const MONGODB_URI = process.env.MONGODB_URI || 'mongodb://localhost:27017/antigravity-meet';
